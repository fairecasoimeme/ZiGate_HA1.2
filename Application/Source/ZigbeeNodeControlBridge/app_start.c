...
PUBLIC void vAppMain(void)
{
    ...
    if (sDeviceDesc.eNodeState == E_RUNNING)
    {
        ...
        vSL_WriteMessage(E_SL_MSG_NODE_NON_FACTORY_NEW_RESTART, 1,(uint8*) &sDeviceDesc.eNodeState,0);
    }
    else
    {
        vSL_WriteMessage(E_SL_MSG_NODE_FACTORY_NEW_RESTART, 1,(uint8*) &sDeviceDesc.eNodeState,0);
    }
...
PUBLIC void app_vFormatAndSendUpdateLists(void)
{
    ...
    /* Cluster list endpoint HA */
        ...
        *(pu8Buffer++) = ZIGBEENODECONTROLBRIDGE_HA_ENDPOINT;
        ...
        vSL_WriteMessage(E_SL_MSG_NODE_CLUSTER_LIST, (sizeof(uint8)+sizeof(uint16)+ sizeof(u16ClusterListHA)), au8LinkRxBuffer,0);
        ...
        /* Cluster list endpoint HA */
            ...
            *(pu8Buffer++) = ZIGBEENODECONTROLBRIDGE_HA_ENDPOINT;
            ...
            vSL_WriteMessage(E_SL_MSG_NODE_CLUSTER_LIST, (sizeof(uint8)+sizeof(uint16)+ sizeof(u16ClusterListHA2)), au8LinkRxBuffer,0);
    ...
    /* Cluster list endpoint ZLL */
        ...
        *(pu8Buffer++) = ZIGBEENODECONTROLBRIDGE_ZLL_COMMISSION_ENDPOINT;
        ...
        vSL_WriteMessage(E_SL_MSG_NODE_CLUSTER_LIST, (sizeof(uint8)+sizeof(uint16)+ sizeof(u16ClusterListZLL)), au8LinkRxBuffer,0);
    ...
    for(u8Count=0;u8Count < 13; u8Count++)
    {
        ...
        *(pu8Buffer++) = ZIGBEENODECONTROLBRIDGE_HA_ENDPOINT;
        ...
        vSL_WriteMessage(E_SL_MSG_NODE_ATTRIBUTE_LIST, (sizeof(uint8)+sizeof(uint16)+sizeof(uint16)+asAttribCommand[u8Count].u32Asize), au8LinkRxBuffer,0);
        pu8Buffer = au8LinkRxBuffer;
        *(pu8Buffer++) = ZIGBEENODECONTROLBRIDGE_HA_ENDPOINT;
        u16ProfileId = 0x0104;
        memcpy(pu8Buffer,&u16ProfileId,sizeof(uint16));
        ...
        vSL_WriteMessage(E_SL_MSG_NODE_COMMAND_ID_LIST, (sizeof(uint8)+sizeof(uint16)+sizeof(uint16)+asAttribCommand[u8Count].u32Csize), au8LinkRxBuffer,0);
    }
        ...
        *(pu8Buffer++) = ZIGBEENODECONTROLBRIDGE_ZLL_COMMISSION_ENDPOINT;
        ...
        vSL_WriteMessage(E_SL_MSG_NODE_COMMAND_ID_LIST, (sizeof(uint8)+sizeof(uint16)+sizeof(uint16)+sizeof(u8CommandsUtility)), au8LinkRxBuffer,0);
